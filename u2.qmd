...
10. **Epigenetics:** effects are most powerful in early development, the ability for genes to turn on and off based on environmental factors. "As a result of life events, chemicals attach themselves to DNA and direct gene activities" Maté (2010) (p. 204).
...
*Note:* During class you will be doing an activity that revolves around the skill of emotion coaching and validation, so make sure you read Chapters 2 and 3 in Lafrance et al. (2020).
