...
1. Demonstrate knowledge of some of the major researchers in the field of trauma
2. Distinguish between emotional abuse, physical abuse, and sexual abuse
3. Identify some of the signs and triggers of trauma
4. Begin to conceptualize a trauma case
5. Use the validation skill outlined in emotion-focused family therapy (EFFT)
...
::: learning-activity
1.  Watch: What is Trauma? 
2.  Read: The Body Keeps the Score, Prologue
3.  Read (Optional): The Body Keeps the Score, Chapter 3
4.  Watch: A Note on Childhood Trauma and Adverse Childhood Experiences
5.  Visit: Terminology Website
6.  Read: The Body Keeps the Score, Chapter 4
7.  Read: In the Realm of Hungry Ghosts, Chapters 17 and 18
8.  Read (Optional): The Effects of Complex Trauma on Brain Development
9.  Read (Optional): Treating Adult Survivors of Childhood Emotional Abuse and Neglect, pp. 3–12
10. Read (Optional): Treating Adult Survivors of Childhood Emotional Abuse and Neglect
11. Read (Optional): Complex Trauma and the Christian Context
12. Read: Emotion-Focused Family Therapy, pp. 3–48
13. Exploration (Optional): Trauma-Informed Therapies
14. Read: Case Study 
...
The resources provided for this topic will discuss the areas of the brain trauma affects and how it differs from stress. Dr. Bessel van der Kolk’s famous book *The Body Keeps the Score* [-@vanderkolkBodyKeepsScore2015] will also be discussed, and we will conclude this section with some definitions and key terms you should know.
...
-   [*What is Trauma? The Author of "The Body Keeps the Score" Explains*](https://youtu.be/BJfmfkDQb14){target="_blank"} [-@bigthinkWhatTraumaAuthor2021]

::: video-container
{{< video https://youtu.be/BJfmfkDQb14 >}}
:::

-   [*Three Ways Trauma Can Change the Brain*](https://www.youtube.com/watch?v=LKWUmwxi1ZI){target="_blank"} [-@nicabmThreeWaysTrauma2014]
...
-   [*The Body Keeps the Score*](assets/u1/PROLOGUE_%20FACING%20TRAUMA.pdf){target="_blank"}, Prologue [-@vanderkolkBodyKeepsScore2015]
...
-   [*The Body Keeps the Score*, Chapter 3](assets/u1/Ch3_TBKS.pdf){target="_blank"} [-@vanderkolkBodyKeepsScore2015]

**Highlights from the reading are described in the following paragraphs (van der Kolk, 2015):**
...
-   [*Bessel van der Kolk on the Treatment of Trauma: How Childhood Trauma is Different from PTSD*](https://www.youtube-nocookie.com/embed/UxPAt-Esv8Q){target="_blank"} [-@nicabmBesselVanKolk2013]
...
-   [*How Childhood Trauma Affects Health Across a Lifetime*](https://www.youtube.com/watch?v=95ovIJ3dsNk){target="_blank"} [-@burkeharrisHowChildhoodTrauma2015]
...
-   [*Take Your ACE Test*](https://stopabusecampaign.org/take-your-ace-test/){target="_blank"} [-@stopabusecampaigncorporationWhatYourACE]
:::::
...
-   [*Complex Trauma Resources*](https://www.complextrauma.org/glossary){target="_blank"} [-@Glossary]
...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=449" width="100%" height="100%" frameborder="0" allowfullscreen="allowfullscreen" title>
...
-   Watch [*What is trauma? The author of "The Body Keeps the Score" explains \| Bessel van der Kolk \| Big Think*](https://www.youtube.com/watch?v=BJfmfkDQb14){target="_blank"}[-@bigthinkWhatTraumaAuthor2021].

::: video-container
{{< video https://www.youtube.com/watch?v=BJfmfkDQb14 >}}
:::

-   Read [*The Body Keeps the Score*](assets/u1/Ch4_TBKS.pdf){target="_blank"}, Chapter 4 [-@vanderkolkBodyKeepsScore2015]

> "When you can’t be fully here, you go to the places where you did feel alive—even if those places are filled with horror and misery" [@vanderkolkBodyKeepsScore2015, p. 73].
...
-   [*The Effects of Complex Trauma on Brain Development*](https://www.complextrauma.org/complex-trauma/the-effects-of-complex-trauma-on-brain-development/){target="_blank"} [-@EffectsComplexTrauma]
:::

### Activity: Optional Reading | Treating Adult Survivors of Childhood Emotional Abuse and Neglect, pp. 3–12

::: learning-activity
Literature in this section discusses emotional abuse or neglect and psychological trauma. Emotional and psychological trauma is a relatively new and complex area of trauma study, and it is crucial that we learn how this affects the systems in which we live, work, and commune. As you read this section, keep the authors’ working definition of complex trauma in the back of your mind—they identify complex trauma as defined by Courtois [-@courtoisComplexTraumaComplex2004] and Courtois & Ford, [2010, as cited in @hopperTreatingAdultSurvivors2021]:

> "Courtois [-@courtoisComplexTraumaComplex2004] articulated … complex trauma as a *recurrent* and *escalating* form of trauma, occurring primarily within familial or intimate relationships ... requiring survival to take precedence over normal psychobiological development" [Courtois & Ford, 2010, as cited in @hopperTreatingAdultSurvivors2021, p. 9].

Additionally, they note that the Complex Trauma Workgroup has a similarly developmentally anchored definition of complex trauma as "a *dualistic*, pernicious, and *progressive relationship* *between exposure and adaptation*" [as cited in @hopperTreatingAdultSurvivors2021, p. 9].

-   Read pages 3 to 12 in [*Treating Adult Survivors of Childhood Emotional Abuse and Neglect: Component-Based Psychotherapy*](https://www.scribd.com/document/459294314/Treating-Adult-Survivors-of-Childhood-Emotional-Abuse-and-Neglect-pdf){target="_blank"} (2021)
...
4.  How does Courtois [-@courtoisComplexTraumaComplex2004] define complex trauma?
...
-   [*Treating Adult Survivors of Childhood Emotional Abuse and Neglect*](https://www.scribd.com/document/459294314/Treating-Adult-Survivors-of-Childhood-Emotional-Abuse-and-Neglect-pdf){target="_blank"} (2021)
...
-   [*Emotion-Focused Family Therapy: A Transdiagnostic Model for Caregiver-Focused Interventions*](https://psycnet.apa.org/PsycBOOKS/toc/16145){target="_blank"} (2020)
...
-   [EMDR Therapy: Demonstration & Step-by-Step Walkthrough](https://www.youtube.com/watch?v=M2ra8p4MSOk){target="_blank"} [-@thelukincenterEMDRTherapyDemonstration2021]
-   [*Narrative Exposure Therapy (NET)*](https://www.apa.org/ptsd-guideline/treatments/narrative-exposure-therapy){target="_blank"} [-@americanpsychiatricassociationNarrativeExposureTherapy2025]
-   [*Origin of Somatic Experiencing*](http://www.youtube.com/watch?v=L0PsQFoz48g&t=33s){target="_blank"} [-@somaticexperiencinginternationalOriginSomaticExperiencing2012]
-   [Internal Family Systems & CBP & AEDP & STAIR/MPE](https://www.complextrauma.org/treatment/complex-trauma-treatments-for-adults/){target="_blank"} [-@ComplexTraumaTreatments]
-   [ARC Therapy](https://arcframework.org/what-is-arc/){target="_blank"} [-@arcframeworkWhatARC]
:::
...
<iframe src="https://create.twu.ca/h5p/wp-admin/admin-ajax.php?action=h5p_embed&amp;id=456" width="100%" height="100%" frameborder="0" allowfullscreen="allowfullscreen" title>
...
-   Big Think. [-@bigthinkWhatTraumaAuthor2021]. *What is trauma?* The author of "The Body Keeps the Score" explains \[Video\]. [https://www.youtube.com/watch?v=BJfmfkDQb14](https://www.youtube.com/watch?v=BJfmfkDQb14){target="_blank"}
-   NICABM. [-@nicabmThreeWaysTrauma2014]. *Three ways trauma can change the brain* \[Video\]. YouTube. [https://www.youtube-nocookie.com/embed/LKWUmwxi1ZI](https://www.youtube.com/watch?v=LKWUmwxi1ZI){target="_blank"}
-   Burke Harris, Nadine. [-@burkeharrisHowChildhoodTrauma2015]. *How childhood trauma affects health across a lifetime* \[Video\]. YouTube. [https://www.youtube-nocookie.com/embed/95ovIJ3dsNk](https://www.youtube.com/watch?v=95ovIJ3dsNk){target="_blank"}

**Readings**

-   van der Kolk, B. [-@vanderkolkBodyKeepsScore2015]. *The body keeps the score: Brain, mind, and body in the healing of trauma*. Penguin.

**Websites**

-   Complex Trauma. [-@Glossary]. *Complex trauma resources: Glossary*. [https://www.complextrauma.org/glossary/](https://www.complextrauma.org/glossary/){target="_blank"}
...
-   Courtois, C. [-@courtoisComplexTraumaComplex2004]. Complex trauma, complex reactions: Assessment and treatment: *Psychotherapy: Theory, Research, Practice, Training*, *42*(4), 412–425.
-   Courtois, C., & Ford, J. D. (Eds.). [-@courtoisTreatingComplexTraumatic2009]. *Treating complex traumatic stress disorder: Scientific foundations and therapeutic models*. Guilford Press.
-   [Hopper, E. K., Grossman, F. K., Spinazzola, J., & Zucker, M. (2021). *Treating adult survivors of childhood emotional abuse and neglect: Component-based psychotherapy*. The Guilford Press.](assets/u1/Treating%20Adult%20Survivors%20of%20Childhood%20Emotional%20Abuse%20and%20Neglect.pdf){target="_blank"}
-   Maté, G. [-@mateRealmHungryGhosts2010]. *In the realm of hungry ghosts*. North Atlantic Books.
-   van der Kolk, B. [-@vanderkolkBodyKeepsScore2015]. *The body keeps the score: Brain, mind, and body in the healing of trauma*. Penguin.

**Websites**

-   Complex Trauma. [-@EffectsComplexTrauma]. The effects of complex trauma on brain development. [https://www.complextrauma.org/complex-trauma/the-effects-of-complex-trauma-on-brain-development/](https://www.complextrauma.org/complex-trauma/the-effects-of-complex-trauma-on-brain-development/){target="_blank"}
...
-   [EMDR Therapy: Demonstration & Step-by-Step Walkthrough](https://www.youtube.com/watch?v=M2ra8p4MSOk){target="_blank"} [@thelukincenterEMDRTherapyDemonstration2021]
-   Somatic Experiencing International. [-@somaticexperiencinginternationalOriginSomaticExperiencing2012]. *Origin of somatic experiencing* \[Video\]. YouTube. [https://www.youtube.com/watch?v=L0PsQFoz48g](https://www.youtube.com/watch?v=L0PsQFoz48g){target="_blank"}

**Readings**

-   Hopper, E. K., Grossman, F. K., Spinazzola, J., & Zucker, M. [-@hopperTreatingAdultSurvivors2021]. *Treating adult survivors of childhood emotional abuse and neglect: Component-based psychotherapy*. Guilford Press.
-   Lafrance, A., Henderson, K. A., & Mayman, S. [-@lafranceEmotionfocusedFamilyTherapy2020]. *Emotion-focused family therapy: A transdiagnostic model for caregiver-focused interventions*. American Psychological Association.
-   Pressley, J., & Spinazzola, J. [-@pressleySurvivalApplicationComplex2015]. Beyond survival: Application of a complex trauma treatment model in the Christian context. *Journal of Psychology and Theology*, *43*(1), 8–22. [https://psycnet.apa.org/doi/10.1177/009164711504300102](https://psycnet.apa.org/doi/10.1177/009164711504300102){target="_blank"}

**Websites**

-   American Psychiatric Association. [-@americanpsychiatricassociationNarrativeExposureTherapy2025]. *PTSD guideline*. [https://www.apa.org/ptsd-guideline/treatments/narrative-exposure-therapy](https://www.apa.org/ptsd-guideline/treatments/narrative-exposure-therapy){target="_blank"}
-   Complex Trauma Resources. [-@ComplexTraumaTreatments] *Treatments for adults - Accelerated experiential dynamic psychotherapy (AEDP)*. [https://www.complextrauma.org/treatment/complex-trauma-treatments-for-adults/](https://www.complextrauma.org/treatment/complex-trauma-treatments-for-adults/){target="_blank"}
-   Stop Abuse Campaign. [-@stopabusecampaigncorporationWhatYourACE]. *Take your ACE test*. [https://stopabusecampaign.org/take-your-ace-test/](https://stopabusecampaign.org/take-your-ace-test/){target="_blank"}
-   ARC Framework. [-@arcframeworkWhatARC] *What is ARC*. [https://arcframework.org/what-is-arc/](https://arcframework.org/what-is-arc/){target="_blank"}
-   Somatic Experiencing International. [-@somaticexperiencinginternationalOriginSomaticExperiencing2012]. *Origin of somatic experiencing* \[Video\]. YouTube. [https://www.youtube.com/watch?v=L0PsQFoz48g](https://www.youtube.com/watch?v=L0PsQFoz48g){target="_blank"}-->
