...
-   [*What is Trauma? The Author of "The Body Keeps the Score" Explains*](http://www.youtube-nocookie.com/embed/BJfmfkDQb14?si=asC9vWgUqFl43TqY){target="_blank"} [-@bigthinkWhatTraumaAuthor2021]
...
-   [*The Body Keeps the Score*](assets/u1/BKTS_Prologue.pdf){target="_blank"}, Prologue [-@vanderkolkBodyKeepsScore2015]
...
-   [*The Body Keeps the Score*, Chapter 3](assets/u1/TBKTS_Ch.3.pdf){target="_blank"} [-@vanderkolkBodyKeepsScore2015]
...
-   Read [*The Body Keeps the Score*](assets/u1/TBKS_Ch_4.pdf){target="_blank"}, Chapter 4 [-@vanderkolkBodyKeepsScore2015]
